...
O  objetivo dessa  regressão não  é  determinar o  melhor valor  de
parâmetro do  modelo, mas sim determinar  um distribuição posterior
para  os parâmetros  do  modelos.  Além da  resposta  do modelo  ser
proviniente da distribuição de probabilidade, os parâmetros também
são oriundos dessa distribuição.
